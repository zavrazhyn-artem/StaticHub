...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'services.battlenet.client_id' => 'string',
            'services.battlenet.client_secret' => 'string',
            'services.battlenet.redirect' => 'string',
            'services.battlenet.region' => 'string',
            'services.discord.public_key' => 'string',
            'services.discord.bot_token' => 'string',
            'services.discord.client_id' => 'string',
            'services.discord.client_secret' => 'string',
            'services.discord.redirect' => 'string',
            'services.discord.webhook_url' => 'string',
            'services.wcl.public_key' => 'string',
            'services.wcl.private_key' => 'string',
...
'services.battlenet.client_id','services.battlenet.client_secret','services.battlenet.redirect','services.battlenet.region','services.discord.public_key',
'services.discord.bot_token','services.discord.client_id','services.discord.client_secret','services.discord.redirect','services.discord.webhook_url',
'services.wcl.public_key','services.wcl.private_key','services.gemini.key','services.gemini.api_key','session.driver',
...
'session.serialization','data.date_format','data.date_timezone','data.features.cast_and_transform_iterables','data.features.ignore_exception_when_trying_to_set_computed_property_value',
...
'signed','throttle','verified','has_static','ensure_has_static',);
        registerArgumentsSet('routes', 'dashboard',
'consumables.index','consumables.store','characters.index','characters.import','characters.assign',
'personal-reports','roster.updateParticipation','statics.dashboard','statics.roster','statics.roster.overview',
'statics.treasury','statics.treasury.store','statics.settings.schedule','statics.settings.schedule.update','statics.settings.discord.test',
'statics.settings.logs','statics.settings.logs.update','statics.logs.index','statics.logs.manual.store','statics.logs.show',
'statics.invite.generate','schedule.index','schedule.store','schedule.event.show','schedule.event.rsvp',
'schedule.announce','profile.edit','profile.update','profile.destroy','profile.discord.link',
'profile.discord.callback','profile.discord.unlink','statics.setup','statics.store','statics.import',
'onboarding.index','onboarding.create','statics.join','statics.join.process','battlenet.redirect',
'battlenet.callback','logout','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'auth.confirm-password','auth.forgot-password','auth.login','auth.register','auth.reset-password',
'auth.verify-email','characters.index','characters.personal_reports','components.application-logo','components.auth-session-status',
'components.consumable-card','components.danger-button','components.dropdown','components.dropdown-link','components.input-error',
'components.input-label','components.ledger-row','components.modal','components.nav-link','components.player-card',
'components.primary-button','components.responsive-nav-link','components.secondary-button','components.stat-card','components.text-input',
'consumables.index','dashboard','dashboard.show','layouts.app','layouts.guest',
'layouts.navigation','onboarding.index','profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form',
'profile.partials.update-profile-information-form','roster.index','roster.overview','schedule.index','schedule.show',
'statics.join','statics.logs.index','statics.logs.show','statics.settings._tabs','statics.settings.logs',
'statics.settings.schedule','statics.setup','treasury.index','welcome','laravel-exceptions-renderer::components.badge',
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','BATTLE_NET_CLIENT_ID',
'BATTLE_NET_CLIENT_SECRET','BATTLE_NET_REDIRECT_URI','DISCORD_WEBHOOK_URL','DISCORD_PUBLIC_KEY','DISCORD_BOT_TOKEN',
'DISCORD_CLIENT_ID','DISCORD_CLIENT_SECRET','DISCORD_REDIRECT_URI','GEMINI_API_KEY','WCL_CLIENT_ID',
'WCL_CLIENT_SECRET',);
