<x-app-layout>
    <div class="mb-12">
        <div class="flex justify-between items-end mb-4">
            <div>
                <span class="text-cyan-400 font-headline text-xs font-bold uppercase tracking-[0.3em] mb-2 block">— Strategic Command</span>
                ...
                <p class="text-on-surface-variant font-medium mt-2 max-w-2xl text-sm leading-relaxed">
                    Manage your active roster for the current Mythic tier. Designate your main and alts to assist the Guild Master in raid composition planning.
                </p>
            </div>
            ...
            <form action="{{ route('roster.updateParticipation', $static->id) }}" method="POST"
                ...
                <div class="bg-surface-container-high rounded-xl border border-white/5 overflow-hidden">
                    ...
                    <div class="bg-black/40 px-8 py-5 border-b border-white/5 grid grid-cols-12 items-center">
                        ...
                        <div class="col-span-2 font-headline text-[10px] font-bold uppercase tracking-[0.2em] text-on-surface-variant text-center">Item Level</div>
                        <div class="col-span-2 font-headline text-[10px] font-bold uppercase tracking-[0.2em] text-on-surface-variant">Realm</div>
                        <div class="col-span-1 font-headline text-[10px] font-bold uppercase tracking-[0.2em] text-on-surface-variant text-center">Main</div>
                        <div class="col-span-1 font-headline text-[10px] font-bold uppercase tracking-[0.2em] text-on-surface-variant text-center">Alt</div>
                        <div class="col-span-2 font-headline text-[10px] font-bold uppercase tracking-[0.2em] text-on-surface-variant">Role</div>
                    </div>
                                ...
                                <div class="col-span-4 flex items-center gap-4">
                                    ...
                                    <div>
                                        <div class="font-headline font-bold text-{{ $classColor }} text-base tracking-tight leading-none mb-1 flex items-center gap-2">
                                            {{ $character->name }}
                                            @if($pivotRole === 'main')
                                                <span class="px-1.5 py-0.5 rounded-full bg-primary/20 text-primary border border-primary/30 text-[8px] uppercase tracking-widest font-black">Main</span>
                                            @endif
                                        </div>
                                ...
                                <div class="col-span-2">
                                    <div class="relative">
                                        <select name="combat_roles[{{ $character->id }}]"
                                            ...
                                            <option value="tank" {{ $pivotCombatRole === 'tank' ? 'selected' : '' }}>Tank</option>
                                            <option value="heal" {{ $pivotCombatRole === 'heal' ? 'selected' : '' }}>Healer</option>
                                            <option value="mdps" {{ $pivotCombatRole === 'mdps' ? 'selected' : '' }}>Melee DPS</option>
                                            <option value="rdps" {{ $pivotCombatRole === 'rdps' ? 'selected' : '' }}>Ranged DPS</option>
                                        </select>
                    ...
                    <div class="p-6 bg-black/20 text-center border-t border-white/5">
                        <p class="text-[10px] font-bold uppercase tracking-[0.3em] text-on-surface-variant flex items-center justify-center gap-2">
                            ...
                            Status: Ready to Sync • Changes are saved automatically
                        </p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-12 pb-24">
                    ...
                    <div class="bg-surface-container-high p-8 rounded-xl relative overflow-hidden group border border-white/5">
                        ...
                        <h3 class="font-headline text-primary text-xs font-bold uppercase tracking-[0.3em] mb-8">Tactical Analytics</h3>
                        <div class="flex gap-16">
                            <div>
                                <div class="text-on-surface-variant text-[10px] font-bold uppercase tracking-widest mb-1">Average iLevel</div>
                            ...
                            <div>
                                <div class="text-on-surface-variant text-[10px] font-bold uppercase tracking-widest mb-1">Alt Synergy</div>
                    ...
                    <div class="bg-surface-container-high p-8 rounded-xl relative overflow-hidden group border border-white/5">
                        ...
                        <p class="text-on-surface-variant text-xs font-medium max-w-sm leading-relaxed mb-6">
                            Your current selection provides coverage for 4 major roles across different armor types.
                        </p>
