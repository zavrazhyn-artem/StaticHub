<div class="flex items-center gap-2 border-b border-white/5 mb-8">
    <a href="{{ route('statics.settings.profile', $static) }}"
       class="px-6 py-4 font-headline text-xs font-bold uppercase tracking-widest transition-all relative group {{ request()->routeIs('statics.settings.profile') ? 'text-primary' : 'text-on-surface-variant hover:text-white' }}">
