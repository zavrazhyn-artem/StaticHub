<x-app-layout>
    <settings-discord
        ...
        test-notification-channel-url="{{ route('statics.settings.discord.test-notification-channel', $static) }}"
        ...
        delete-notification-channel-message-url="{{ route('statics.settings.discord.notification-channel-message.delete', [$static, ':messageId']) }}"
