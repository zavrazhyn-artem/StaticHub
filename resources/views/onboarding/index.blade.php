<x-app-layout>
    <div class="mb-12">
        <div class="flex justify-between items-end mb-4">
            <div>
                <span class="text-cyan-400 font-headline text-xs font-bold uppercase tracking-[0.3em] mb-2 block">— Tactical Onboarding</span>
                <h2 class="font-headline text-4xl font-black text-white uppercase tracking-tighter italic">
                    Establish Your Command
                </h2>
                <p class="text-on-surface-variant font-medium mt-2 max-w-2xl text-sm leading-relaxed">
                    Join an existing static or create your own to begin coordinating your raid operations.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="space-y-12">
        @if($isGuildMaster)
            <div class="bg-primary/10 border border-primary/20 p-6 rounded-xl flex items-start gap-4">
                ...
                <div>
                    <h3 class="text-primary font-headline font-bold text-sm uppercase tracking-widest mb-1">Guild Master Detected</h3>
                    <p class="text-on-surface-variant text-sm">We see you are the Guild Master of <strong>{{ $guildName }}</strong>. Would you like to create a Static Group for your guild?</p>
                </div>
            </div>
        @endif
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="bg-surface-container-high p-8 rounded-xl border border-white/5 relative overflow-hidden group">
                ...
                <form action="{{ route('onboarding.create') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        <label class="block text-on-surface-variant text-[10px] font-bold uppercase tracking-widest mb-2" for="region">Region</label>
                        <div class="relative">
            ...
            <div class="bg-surface-container-low p-8 rounded-xl border border-white/5 flex flex-col justify-center items-center text-center relative overflow-hidden">
                <div class="mb-8">
                    ...
                    <h3 class="font-headline text-white text-lg font-bold uppercase tracking-widest mb-2">Joining a Group?</h3>
                    <p class="text-on-surface-variant text-sm max-w-xs mx-auto">
                        Ask your Raid Leader for an invite link. It should look like this:
                    </p>
                </div>
                ...
                <div class="flex items-center gap-3 text-[10px] font-bold uppercase tracking-widest text-on-surface-variant/50">
                    ...
                    Once you click the link, you'll be able to select your character.
                </div>
            </div>
        </div>
    </div>
