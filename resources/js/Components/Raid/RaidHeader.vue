    ...
    <div class="space-y-4">
        <div class="flex items-center gap-3">
            ...
            <h1 class="text-4xl font-black text-white uppercase tracking-tight font-headline leading-tight">
                {{ event.static?.name || __('Raid Event') }}
            </h1>
        </div>
        ...
        <div class="flex flex-col lg:flex-row items-stretch lg:items-center justify-between gap-4 w-full">
            ...
            <div class="flex flex-wrap items-center gap-3">
                ...
                <div class="bg-surface-container-high border border-white/10 rounded-xl px-4 h-10 glassmorphism backdrop-blur-md shadow-2xl flex items-center gap-4">
                    <div class="flex items-center gap-2 text-white font-headline text-2xs font-bold uppercase tracking-wider leading-none">
                        <span class="material-symbols-outlined text-sm text-fuchsia-400">calendar_today</span>
                        <span>{{ formatDate(event.start_time) }}</span>
                    </div>
                    <div class="flex items-center gap-2 text-white font-headline text-2xs font-bold uppercase tracking-wider leading-none border-l border-white/10 pl-4">
                ...
                >
                    ...
                    <span class="text-3xs font-bold uppercase tracking-wider" :class="difficulty.color">{{ difficulty.label }}</span>
                </div>
                ...
                <div class="h-10 px-3 rounded-xl bg-white/5 border border-white/10 flex items-center gap-1.5">
                    ...
                    <span class="text-3xs font-bold uppercase tracking-wider" :class="status.color">{{ status.label }}</span>
                </div>
                ...
                >
                    ...
                    <span class="text-3xs font-bold uppercase tracking-wider text-yellow-400">Optional</span>
                </div>
            ...
            >
                <div class="text-white font-headline text-2xs font-bold uppercase tracking-[0.15em] leading-none opacity-80 truncate">
