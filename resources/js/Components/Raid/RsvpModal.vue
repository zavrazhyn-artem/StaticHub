        ...
        <div class="p-8">
            ...
            <form :action="rsvpRoute" method="POST" class="space-y-6">
                ...
                <div v-if="availableSpecs.length > 0" class="space-y-2">
                    <label class="text-[10px] font-black uppercase tracking-widest text-on-surface-variant ml-2">{{ __('Specialization') }}</label>
                    <div class="grid grid-cols-3 gap-2">
                        ...
                        >
                            ...
                            <span class="text-[9px] font-bold text-white">{{ spec.name }}</span>
                            <span
                                class="text-[7px] font-black uppercase tracking-wide px-1 py-0.5 rounded-full border"
