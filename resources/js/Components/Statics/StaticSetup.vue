    ...
    <div class="space-y-8 max-w-xl mx-auto">
        ...
        <div class="bg-surface-container-low border border-white/5 rounded-xl p-8">
            ...
            <form id="create-static-form" method="POST" :action="storeUrl" class="space-y-6">
                ...
                <div class="space-y-2">
                    <label for="realm_slug" class="block font-headline text-[10px] font-bold text-on-surface-variant uppercase tracking-widest">{{ __('Server') }}</label>
            ...
            <div class="space-y-4">
                <div v-for="guild in guilds" :key="guild.name"
                    ...
                    <form method="POST" :action="importUrl">
                        ...
                        <button type="submit"
                            class="border border-white/20 text-on-surface-variant hover:border-primary hover:text-primary px-4 py-2 rounded font-headline text-[10px] font-bold uppercase tracking-widest transition-all">
                            {{ __('Import Guild') }}
                        </button>
                    </form>
                </div>
