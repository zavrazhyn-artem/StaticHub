                ...
                <label :class="[
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <div class="text-3xs text-on-surface-variant font-semibold uppercase tracking-wider mt-0.5">
            ...
            <div :class="[
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center justify-between p-4 bg-surface-container-highest border border-white/5 rounded-lg transition-all hover:bg-white/5 group">
                        ...
                        <a v-else
                           :href="discordLinkUrl"
                           class="bg-[#5865F2] hover:bg-[#4752C4] text-white text-3xs font-semibold uppercase tracking-wider py-2 px-4 rounded-sm transition-all active:scale-95 shadow-[0_0_15px_rgba(88,101,242,0.3)] hover:shadow-[0_0_20px_rgba(88,101,242,0.5)]">
                            {{ __('Link Account') }}
                        </a>
                    </div>
                </div>
